...
---
Agora você já entende o que são as variáveis, como criá-las, nomeá-las e usá-las nos seus programas!

Esses conceitos são a base de quase tudo o que você vai fazer em Python, então vale praticar bastante: experimente mudar valores, criar novos nomes e testar combinações diferentes. É assim que você começa a se sentir à vontade escrevendo seus próprios códigos.
