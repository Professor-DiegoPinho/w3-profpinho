...
Python também permite contar de trás para frente:
...
Podemos também acessar **intervalos** da lista usando. Para isso, usamos o índice do início do intervalo e o índice do fim dentro dos colchetes: `lista[início:fim]`.

Mas tem um detalhe importante:o item de _início_ é incluído no intervalo e o de _fim_ **não** é. Observe:
...
Também é possível usar índices negativos para selecionar itens. O intervalo `[-4:-1]` começa em "orange" e vai até antes de "mango":
...
No próximo artigo, vamos explorar como manipulá-las: adicionar, remover, reorganizar e modificar seus valores. Vamos usar os principais recursos que o Python oferece para trabalhar com esse tipo de estrutura.
