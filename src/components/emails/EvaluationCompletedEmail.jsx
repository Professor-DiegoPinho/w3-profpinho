...
export default function EvaluationCompletedEmail({
  studentName = 'Aluno',
  courseName = 'Curso',
  ...
  return (
    <Html lang="pt-BR">
      <Head />
      <Preview>Sua avaliação foi finalizada!</Preview>
        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Section style={badgeSection}>
              <Text style={statusBadge}>AVALIAÇÃO CONCLUÍDA</Text>
            </Section>

            {/* Info Box */}
            <Section style={infoBox}>
              <Text style={infoText}><strong>Curso:</strong> {courseName}</Text>
              <Text style={infoText}><strong>Data:</strong> {completionDate}</Text>
            </Section>
